...
{
public:
   //description: creates an empty chessboard of default size 8
   //pre: and empty board
   //post empty chessboard is assigned with no queens yet on it
   //usage Queens queensOnBoard;
   Queens();

   //description: creates an empty chessboard of users desired size
   //pre: an empty board
   //post empty chessboard is assigned with no queens yet on it
   //usage Queens queensOnBoard;
   Queens(int boardsize);

   //description: destroys a board
   //pre: board exists
   //post: board does not exist
   //usage automatically done at the end of the scope
   ~Queens();

   //description: places a queen on the chessboard
   ...
   //description: removes a queen from the chessboard
   ...
   //description: checks to see of a square on the chessboard is safe for a queen
   ...
   //description: prints the chessboard and queens on it
   ...
   //description: checks to see if the queens problem is solved
   //pre there may or may not be queens on the board
